...
class ReviewsRecord extends FirestoreRecord {
  ...
  // "charterRef" field.
  DocumentReference? _charterRef;
  DocumentReference? get charterRef => _charterRef;
  bool hasCharterRef() => _charterRef != null;
  ...
  void _initializeFields() {
    _charterRef = snapshotData['charterRef'] as DocumentReference?;
...
class ReviewsRecordDocumentEquality implements Equality<ReviewsRecord> {
  ...
  bool equals(ReviewsRecord? e1, ReviewsRecord? e2) {
    return e1?.charterRef == e2?.charterRef &&
